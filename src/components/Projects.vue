...
const projects = computed(() => [
  ...
  {
    id: 3,
    title: 'Personality Country Quiz',
    description:
...
.projects h2 { margin: 0 0 1rem 0; color: var(--nv-green-2) }
.projects-grid { display: grid; gap: 1rem; grid-template-columns: 1fr }
